...
$tasksLine = ' task:encloseAll_jexec_lines' //    . ' /callerProjectId=RSG2'
    . ' /srcRoot="../../testData"' . ' /includeExt="php"' //    . ' /srcRoot="./../../RSGallery2_J4/administrator/components/com_rsgallery2/tmpl/develop"'
...
// $taskFile="./encloseAll_jexec_Files.tsk";
// $taskFile="./build_Develop.tsk";
// $taskFile="./build_release.tsk";
// $taskFile = "";
// $taskFile = '../../J_LangMan4ExtDevProject/.buildPHP/encloseAll_jexec_Files.tsk';
// $taskFile = '../tsk_file_examples/encloseAll_jexec_Files.tsk';
// $taskFile = '../tsk_file_examples/encloseAll_jexec_Files_JG.tsk';
...
if (empty ($hasError))
{
    ...
    $oEncloseAll_jexec_FilesLines = new encloseAll_jexec_LinesFiles();
    ...
    print ($oEncloseAll_jexec_FilesLines->text() . PHP_EOL);
}
