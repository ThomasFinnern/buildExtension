...
$tasksLine = ' task:??' . ' /srcRoot="./../../RSGallery2_J4"' //    . ' /isNoRecursion=true'
    . ' /name=rsgallery2'
...
// $taskFile = "";
$taskFile  = "./extensionsByManifest.tsk";
$tasksLine = "";
...
if (empty ($hasError))
{
    ...
    $oFilesByManifest = new extensionsByManifest();
    ...
    print ($oFilesByManifest->text() . PHP_EOL);
}
