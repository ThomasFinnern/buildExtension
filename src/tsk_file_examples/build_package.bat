...
echo --- "%ExePath%php.exe" doFileTasksCmd.php -f ../../RSGallery2_J4_Dev\.buildPHP\build_package.tsk %OptionFile%
"%ExePath%php.exe" doFileTasksCmd.php -f ../../RSGallery2_J4_Dev\.buildPHP\build_package.tsk %OptionFile%
