...
REM Source path
Call :AddNextArg -t 'task:alignAll_use_Lines /callerProjectId=RSG2 /srcRoot="../../../LangMan4Dev" /includeExt = "php" /isWriteListToFile /listFileName="../../testData/FoundFileNamesList.txt"'
...
echo --- "%ExePath%php.exe" fileNamesListCmd.php -t "task:alignAll_use_Lines /callerProjectId=RSG2 /srcRoot='../../../LangMan4Dev' /includeExt='php' /isWriteListToFile /listFileName='../../testData/FoundFileNamesList.txt'"
"%ExePath%php.exe" fileNamesListCmd.php -t "task:alignAll_use_Lines /callerProjectId=RSG2 /srcRoot='../../../LangMan4Dev' /includeExt='php' /isWriteListToFile /listFileName='../../testData/FoundFileNamesList.txt'"
