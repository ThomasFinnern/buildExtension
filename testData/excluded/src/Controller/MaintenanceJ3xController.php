...
//					}
	...
	{
		$msg     = "MaintenanceJ3xController.resetUpgradeFlags: ";
		$msgType = 'notice';
...
//					}
				...
				{
					$msg     .= "Error at resetUpgradeFlags items";
					$msgType = 'error';
				}
			}
			catch (\RuntimeException $e)
		...
		$link = 'index.php?option=com_rsgallery2&view=MaintenanceJ3x&layout=resetupgradeflags';
		$this->setRedirect($link, $msg, $msgType);
	}
